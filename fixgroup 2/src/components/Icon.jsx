// Shared SVG icons. Gebruikt zowel in Astro als React componenten.
export const Icon = {
  Phone: (p) => (
  ...
  Siren: (p) => (
    <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M7 12a5 5 0 0 1 5-5v0a5 5 0 0 1 5 5v6H7Z"/>
      <path d="M5 20h14"/><path d="M12 4V2"/>
      <path d="m18.5 6.5 1.5-1.5"/><path d="m4 5 1.5 1.5"/>
    </svg>
  ),
  Plus: (p) => (
    <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
